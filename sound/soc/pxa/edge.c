...
//	{13000000,  0x600,    0x40,  1536000, 0x10f,   0x20,	48000},
//	{39000000,  0x200,    0x40,  1536000, 0x248,   0x17,	48000},
					 ...
					 struct snd_pcm_hw_params *hw_params)
{
	...
	ret = snd_soc_dai_set_pll(codec_dai, 0, 0, 0);		// ensure pll is off
