...
/* UART3 */
#define GPIO29_UART3_CTS	MFP_CFG(GPIO29, AF4)
#define GPIO30_UART3_RTS	MFP_CFG(GPIO30, AF4)
#define GPIO31_UART3_TXD	MFP_CFG(GPIO31, AF4)
#define GPIO32_UART3_RXD	MFP_CFG(GPIO32, AF4)
...
#define GPIO19_FM_RDS_IRQ	MFP_CFG(GPIO19, AF0)
#define GPIO20_FM_RESET		MFP_CFG(GPIO20, AF0)
...
#define GPIO16_CAM_PWR_SUB	MFP_CFG_DRV(GPIO16, AF0, MEDIUM)
#define GPIO18_CAM_RESET_SUB	MFP_CFG_DRV(GPIO18, AF0, MEDIUM)
...
/* MMC1 */
#define MMC1_DAT7_MMC1_DAT7	MFP_CFG_PULL_HIGH(MMC1_DAT7, AF0)
#define MMC1_DAT6_MMC1_DAT6	MFP_CFG_PULL_HIGH(MMC1_DAT6, AF0)
#define MMC1_DAT5_MMC1_DAT5	MFP_CFG_PULL_HIGH(MMC1_DAT5, AF0)
#define MMC1_DAT4_MMC1_DAT4	MFP_CFG_PULL_HIGH(MMC1_DAT4, AF0)
#define MMC1_DAT3_MMC1_DAT3	MFP_CFG_PULL_HIGH(MMC1_DAT3, AF0)
#define MMC1_DAT2_MMC1_DAT2	MFP_CFG_PULL_HIGH(MMC1_DAT2, AF0)
#define MMC1_DAT1_MMC1_DAT1	MFP_CFG_PULL_HIGH(MMC1_DAT1, AF0)
#define MMC1_DAT0_MMC1_DAT0	MFP_CFG_PULL_HIGH(MMC1_DAT0, AF0)
#define MMC1_CMD_MMC1_CMD	MFP_CFG_PULL_HIGH(MMC1_CMD, AF0)
...
#define MMC2_CLK_GPIO_42	MFP_CFG_DRV(GPIO42, AF1, MEDIUM)
