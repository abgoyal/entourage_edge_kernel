...
static int lis3lv02d_direction_idx = 0;  
...
#if defined(CONFIG_MMC_PXA_SDH)
#ifdef CONFIG_SD8XXX_RFKILL
	pdata = add_sd8x_rfkill_device(mfp_to_gpio(WLAN_PD_GPIO_14),
		mfp_to_gpio(WLAN_BT_RESET_GPIO_34));
	if (pdata)
		ttc_dkb_sdh_platform_data_1.rfkill_pdata = pdata,
#endif
...
#if defined(CONFIG_SENSORS_LIS3LV02D_I2C) || defined(CONFIG_SENSORS_LIS3LV02D_I2C_MODULE)
	lis3lv02d_direction_idx = is_td_dkb ? 1:0;
